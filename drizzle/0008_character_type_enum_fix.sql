...
UPDATE "characters" SET "type" = 'Other' WHERE "type" IS NOT NULL AND "type" NOT IN ('Boy', 'Girl', 'Baby', 'Man', 'Woman', 'Dog', 'Dragon', 'Fantasy Creature', 'Animal', 'Other');

-- Now safely convert the column type if not already enum
DO $$
BEGIN
	IF EXISTS (
		SELECT 1
