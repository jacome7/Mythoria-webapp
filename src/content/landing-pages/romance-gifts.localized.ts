...
const commonBookMeta = {
  ...
  fictionalLabel: {
    'en-US': 'Fictional example',
    'es-ES': 'Ejemplo ficticio',
    'fr-FR': 'Exemple fictif',
  },
} as const;

function book(
  locale: LocalizedLandingLocale,
  data: Omit<LocalizedBookCopy, 'ageLabel' | 'audioSampleTitle' | 'fictionalLabel'>,
): LocalizedBookCopy {
  return {
    ...data,
    ageLabel: commonBookMeta.ageLabel[locale],
    audioSampleTitle: commonBookMeta.audioSampleTitle[locale],
    fictionalLabel: commonBookMeta.fictionalLabel[locale],
  };
}
...
const books: Record<LocalizedLandingLocale, LocalizedBookCopy[]> = {
  'en-US': [
    book('en-US', {
      ...
      imageAlt:
        'Fictional personalized couples book Emma & Daniel — An Unexpected Love in Brooklyn',
    ...
    book('en-US', {
      ...
      imageAlt: 'Fictional romantic book about a couple remembering their first kiss',
    ...
    book('en-US', {
      ...
      imageAlt: 'Fictional personalized couples book beside two well-used cups',
    ...
    book('en-US', {
      ...
      imageAlt: 'Fictional romantic book Eleanor & Matilda — Two Countries, One Home',
    ...
    book('en-US', {
      ...
      imageAlt: 'Fictional personalized proposal book Ryan & Thomas — The Last Chapter Before Yes',
      styleLabel: 'Minimalist',
  ...
  'es-ES': [
    book('es-ES', {
      ...
      imageAlt: 'Libro ficticio Inés y Diego — Un amor inesperado ambientado en Madrid',
      styleLabel: 'Acuarela',
    ...
    book('es-ES', {
      ...
      imageAlt: 'Libro romántico ficticio sobre una pareja que recuerda su primer beso',
    ...
    book('es-ES', {
      ...
      imageAlt: 'Libro ficticio para parejas junto a dos tazas usadas',
    ...
    book('es-ES', {
      ...
      imageAlt: 'Libro romántico ficticio sobre Leonor y Matilde viviendo en dos países',
    ...
    book('es-ES', {
      ...
      imageAlt: 'Libro ficticio de pedida Raúl y Tomás — El último capítulo antes del sí',
      styleLabel: 'Minimalista',
  ...
  'fr-FR': [
    book('fr-FR', {
      ...
      imageAlt: 'Livre fictif Inès & Hugo — Un amour inattendu situé à Paris',
    ...
    book('fr-FR', {
      ...
      imageAlt: 'Livre romantique fictif sur le souvenir d’un premier baiser',
    ...
    book('fr-FR', {
      ...
      imageAlt: 'Livre fictif pour couples près de deux tasses usées',
    ...
    book('fr-FR', {
      ...
      imageAlt: 'Livre romantique fictif Léonie & Mathilde — Deux pays, un foyer',
    ...
    book('fr-FR', {
      ...
      imageAlt: 'Livre de demande fictif Louis & Thomas — Le dernier chapitre avant oui',
      styleLabel: 'Minimaliste',
...
const copy = {
  'en-US': {
    ...
    quickBody:
      'It is a story created from moments in your relationship—names, places, messages, firsts, trips and small habits—shaped into a book you can review before giving. Only the details you choose are included. You can select the tone, explore fictional examples and adjust the result before sharing it.',
