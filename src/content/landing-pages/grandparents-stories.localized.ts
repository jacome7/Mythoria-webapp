...
const labels = {
  'en-US': { audio: 'Listen to the narrated excerpt', fictional: 'Fictional example' },
  'es-ES': { audio: 'Escuchar el fragmento narrado', fictional: 'Ejemplo ficticio' },
  'fr-FR': { audio: 'Écouter l’extrait raconté', fictional: 'Exemple fictif' },
} as const;

function book(
  locale: LocalizedLandingLocale,
  data: Omit<LocalizedBookCopy, 'audioSampleTitle' | 'fictionalLabel'>,
): LocalizedBookCopy {
  return {
    ...data,
    audioSampleTitle: labels[locale].audio,
    fictionalLabel: labels[locale].fictional,
  };
}
...
const books: Record<LocalizedLandingLocale, LocalizedBookCopy[]> = {
  'en-US': [
    book('en-US', {
      ...
      imageAlt: 'Fictional book Grandma’s Recipe for Stars in a warm family kitchen',
    ...
    book('en-US', {
      ...
      imageAlt: 'Fictional grandparents book about a cardboard Sunday train',
      styleLabel: 'Cartoon',
    ...
    book('en-US', {
      ...
      imageAlt: 'Fictional multilingual family book featuring a suitcase of memories',
    ...
    book('en-US', {
      ...
      imageAlt: 'Fictional intergenerational book with old photographs in a garden',
      styleLabel: 'Vintage',
    ...
    book('en-US', {
      ...
      imageAlt: 'Fictional grandparents and grandchildren vacation book at a yellow house',
      styleLabel: 'Watercolor',
  ...
  'es-ES': [
    book('es-ES', {
      ...
      imageAlt: 'Libro ficticio La receta de estrellas de la abuela en una cocina familiar',
    ...
    book('es-ES', {
      ...
      imageAlt: 'Libro ficticio sobre abuelos y un tren de cartón de los domingos',
    ...
    book('es-ES', {
      ...
      imageAlt: 'Libro ficticio sobre una familia multilingüe y una maleta de recuerdos',
      styleLabel: 'Acuarela',
    ...
    book('es-ES', {
      ...
      imageAlt: 'Libro ficticio intergeneracional con fotografías antiguas en un jardín',
      styleLabel: 'Vintage',
    ...
    book('es-ES', {
      ...
      imageAlt: 'Libro ficticio de vacaciones de abuelos y nietos en una casa amarilla',
      styleLabel: 'Acuarela',
  ...
  'fr-FR': [
    book('fr-FR', {
      ...
      imageAlt: 'Livre fictif La recette d’étoiles de Grand-mère dans une cuisine familiale',
    ...
    book('fr-FR', {
      ...
      imageAlt: 'Livre fictif sur des grands-parents et un train du dimanche en carton',
    ...
    book('fr-FR', {
      ...
      imageAlt: 'Livre fictif sur une famille multilingue et une valise de souvenirs',
    ...
    book('fr-FR', {
      ...
      imageAlt: 'Livre intergénérationnel fictif avec de vieilles photos dans un jardin',
      styleLabel: 'Vintage',
    ...
    book('fr-FR', {
      ...
      imageAlt:
        'Livre fictif de vacances entre grands-parents et petits-enfants dans une maison jaune',
      styleLabel: 'Aquarelle',
...
const copy = {
  'en-US': {
    ...
    fitBody: [
      'Use familiar voices, places and traditions to create a warm fictionalized narrative or a careful family keepsake.',
    ...
    booksTitle: 'Five fictional ways to keep a family story',
    booksIntro:
  ...
  'es-ES': {
    ...
    booksTitle: 'Cinco formas ficticias de guardar una historia familiar',
    booksIntro:
  ...
  'fr-FR': {
    ...
    fitBody: [
      'Utilisez voix, lieux et traditions familières pour créer un récit fictif chaleureux ou un souvenir familial attentif.',
    ...
    booksTitle: 'Cinq façons fictives de garder une histoire familiale',
    booksIntro:
