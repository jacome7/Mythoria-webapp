...
export default getRequestConfig(async ({requestLocale}) => {
  ...
  const [commonMessages, authMessages, publicPagesMessages, privacyPolicyMessages, pricingMessages, storyStepsMessages, contactUsPageMessages, myStoriesPageMessages, buyCreditsMessages, publicStoryPageMessages] = await Promise.all([
