 ...
 */
export function generateHreflangLinks(currentLocale: string, pathname?: string): Record<string, string> {
 ...
 */
export async function generateServerHreflangLinks(currentLocale: string): Promise<Record<string, string>> {
