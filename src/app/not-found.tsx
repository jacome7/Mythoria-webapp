      ...
      messages={{
        common: {
          ...
          NotFound: {
            ...
            suggestions: {
              title: "While we search for your lost page, you could:",
              items: [
                "📖 Return to the Homepage and start a new adventure",
                "✨ Create your own magical story",
                "📚 Browse your existing stories",
                "🎯 Check if the URL is spelled correctly (even magic has rules!)"
              ]
            },
            actions: {
